...
const uploadCould = __importStar(require("../../middlewares/admin/uploadCloud.middleware"));
const singerValidate = __importStar(require("../../validates/admin/singer.validate"));
